...
public class RemindUtils {
        ...
        private static String CALENDARS_NAME = "1111";
        private static String CALENDARS_ACCOUNT_NAME = "444";
        private static String CALENDARS_ACCOUNT_TYPE = "4444";
        private static String CALENDARS_DISPLAY_NAME = "5555";
